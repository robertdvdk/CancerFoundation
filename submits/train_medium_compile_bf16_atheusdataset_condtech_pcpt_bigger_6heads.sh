#!/bin/bash -l
#SBATCH --job-name=train_medium_compile_bf16_atheusdataset_condtech_pcpt_bigger_6heads
...
#SBATCH --exclude=gpu-biomed-25,gpu-biomed-26,gpu-biomed-27,gpu-biomed-17
